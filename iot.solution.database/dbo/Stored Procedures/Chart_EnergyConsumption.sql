...
001	SVM-4 22-05-2020 [Nishit Khakhi]	Added Initial Version to represent Energy consumption By Device / Entity
*******************************************************************/
...
BEGIN
    ...
    BEGIN TRY  
		...
		SELECT [name], ISNULL([EnergyConsumption],0) AS [EnergyConsumption] FROM #finalTable
		ORDER BY 
				CASE [name] 
						WHEN '00:00' THEN 1
						WHEN '03:00' THEN 2
