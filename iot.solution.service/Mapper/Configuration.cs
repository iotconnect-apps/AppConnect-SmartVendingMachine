    ...
    public class Configuration
    {
        ...
        public static void Initialize()
        {
            var config = new MapperConfiguration(mc =>
            {
                ...
                mc.CreateMap<Model.Inventory, Entity.Inventory>().ReverseMap();
                mc.CreateMap<Model.InventoryDetail, Entity.InventoryDetail>().ReverseMap();
                ...
                mc.CreateMap<Model.Product, Entity.Product>().ReverseMap();
                mc.CreateMap<Entity.ProductModel, Entity.Product>().ReverseMap();
                ...
                mc.CreateMap<Model.InventoryDetail, Entity.Inventory>().ReverseMap();
